...
public class LutemonListAdapter extends RecyclerView.Adapter<LutemonViewHolder> {
    ...
    public void onBindViewHolder(@NonNull LutemonViewHolder holder, int position) {
        ...
        holder.lutemonHealth.setText("Health:" + String.valueOf(lutemons.get(position).health) + "/" + String.valueOf(lutemons.get(position).maxHealth));
        holder.lutemonExperience.setText("Experience points:" + String.valueOf(lutemons.get(position).experience));
